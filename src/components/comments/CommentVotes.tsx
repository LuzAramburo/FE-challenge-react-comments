...
export const CommentVotes = () => {
  return (
    <div className="bg-blue-50 text-primary rounded font-medium mr-4">
      <button className="bg-inherit text-inherit flex justify-center items-center rounded-t transition-colors flex-grow w-10 h-10 group">
      ...
      <button className="bg-inherit text-inherit flex justify-center items-center rounded-b transition-colors flex-grow w-10 h-8 group">
